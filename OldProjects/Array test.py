...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for i in range(15):
      ...
      p300.well_bottom_clearance.aspirate = 1.0
      p300.distribute(amounts[0], source, destination, new_tip = 'never', blow_out = True, blowout_location = 'source well', disposal_volume = 0)
